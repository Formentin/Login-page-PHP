        ...
        <div class="box">
            <div class="box_image_container">
                ...
                <div class="box_image_container_down">
                    <div class="box_image_container_down_text">
                        <p>Welcome to <i>register</i> page!</p>
                        <ul>
            ...
            <div class="box_quests">
                ...
                <form action="" method="post" class="answer_form">
                    ...
                    <input type="password" name="r_password" placeholder="Confirm Password">
...
function validateEmail($email, $result, $password)
{
...
validateEmail($email, $result, $password);
